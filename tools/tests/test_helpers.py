...
class TestGtfsSpecificFunctions(TestCase):
    ...
    @patch("tools.helpers.load_gtfs")
    def test_extract_gtfs_calendar_no_calendar_or_calendar_dates(self, mock_load_gtfs):
    ...
    @patch("tools.helpers.load_gtfs")
    def test_extract_gtfs_calendar_only_calendar_dates(self, mock_load_gtfs):
    ...
    @patch("tools.helpers.load_gtfs")
    def test_extract_gtfs_calendar_both_calendar_and_calendar_dates(self, mock_load_gtfs):
